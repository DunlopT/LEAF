...
For the DFM example, Spencer_no_waves, the following files require updating to couple the DFM model with LEAF (v.2.0) and ensure that vegetation is activated in DFM.
...
3. LEAF_inputs_example_Spencer_no_waves_v.2.0.json
...
This file specifies the coordinates of the area in which mangroves are represented in DFM. The size and changes to these mangroves however, are calculated in the LEAF model.
