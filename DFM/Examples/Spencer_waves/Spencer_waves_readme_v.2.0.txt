...
For the DFM example, Spencer_waves, the following files require updating to couple the DFM model with LEAF (v.2.0) and ensure that vegetation is activated in DFM.
...
3. LEAF_inputs_example_Spencer_waves_v.2.0.json
