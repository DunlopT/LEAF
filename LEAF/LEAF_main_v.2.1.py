...
This script comprises the main code for the LEAF model version 2.1 (dated 29.07.2025).
...
For simplicity in LEAF version 2.1, all lifecycle calculations are conducted in this code.

v.2.1 Updated (29.07.2025)

Sea level rise
- A new input parameter (annualslr) has been included to adjust the pneumatophore growth ceiling (pnelimit) with sea level rise.
...
annualslr = parameters['5. Other mangrove parameters']['annualslr'] # 5K. Annual sea level rise rate (m/yr) (v.2.1 update)
# 6. Establishment
...
# ======================================================================
# SEA LEVEL RISE (v.2.1 update)
# ======================================================================
# Calculate the rate of sea level rise per timestep
timestepslr = annualslr / (365*24*3600) * mtpervt
print('Sea level rise per timestep:', timestepslr, 'm')
...
for i in range(0,nt): # Where i represents the time step
    ...
    # Update pneumatophore growth ceiling based on sea level rise per timestep (v.2.1 update)
    pnelimit += timestepslr
